    ...
    changeResourceRecordSet(action, domain) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (route53Params.routingPolicy === globals_1.default.routingPolicies.latency) {
                routingOptions = Object.assign({ Region: domain.region, SetIdentifier: (_a = domain.route53Params.setIdentifier) !== null && _a !== void 0 ? _a : domain.domainInfo.domainName }, route53healthCheck);
            }
            if (route53Params.routingPolicy === globals_1.default.routingPolicies.weighted) {
                routingOptions = Object.assign({ Weight: domain.route53Params.weight, SetIdentifier: (_b = domain.route53Params.setIdentifier) !== null && _b !== void 0 ? _b : domain.domainInfo.domainName }, route53healthCheck);
            }
